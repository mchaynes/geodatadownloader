...
export async function parseGeometryFromString(str: string): Promise<Geometry> {
    const EsriExtent = await import("@arcgis/core/geometry/Extent");
    const EsriPolygon = await import("@arcgis/core/geometry/Polygon");
